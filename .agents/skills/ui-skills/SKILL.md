---
name: ui-skills
description: Use before UI-related work to select the smallest useful UI Skills context from the ui-skills system (baseline-ui, improve-ui, create-design-md, fixing-accessibility, fixing-metadata, fixing-motion-performance).
license: MIT
metadata:
  author: ibelick
  version: "1.0.0"
