...
return [
    ...
    'settings' => [
        SiteSettings::class,
        \App\Domain\Settings\Settings\PaymentGatewaySettings::class,
        \App\Domain\Settings\Settings\PlatformMailSettings::class,
        \App\Domain\Settings\Settings\PlatformStorageSettings::class,
    ],
    ...
    'auto_discover_settings' => [
        app_path('Domain/Settings/Settings'),
    ],
